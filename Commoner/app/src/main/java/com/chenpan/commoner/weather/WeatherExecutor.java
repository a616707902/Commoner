package com.chenpan.commoner.weather;
...
public class WeatherExecutor implements AMapLocalWeatherListener {
    ...
    public WeatherExecutor(Context context, View navigationHeader,  AMapLocalWeatherLive mAMapLocalWeatherLive) {
        mContext =context;
       this. mAMapLocalWeatherLive=mAMapLocalWeatherLive;
        ButterKnife.bind(this, navigationHeader);
    }

    public void execute() {
        if (mAMapLocalWeatherLive != null && mAMapLocalWeatherLive.getAMapException().getErrorCode() == 0) {
            updateView(mAMapLocalWeatherLive);
            release();
        } else {
    ...
    private void updateView(AMapLocalWeatherLive aMapLocalWeatherLive) {
        ...
        tvWerther.setText(aMapLocalWeatherLive.getWeather());
