...
public class CoverLoader {
    ...
    public Bitmap loadThumbnail(String uri) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (bitmap == null) {
                bitmap = loadBitmap(uri, ContextUtils.getScreenWidth() / 10);
                if (bitmap == null) {
    ...
    public Bitmap loadBlur(String uri) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (bitmap == null) {
                bitmap = loadBitmap(uri, ContextUtils.getScreenWidth() / 2);
                if (bitmap == null) {
    ...
    public Bitmap loadRound(String uri) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(MyApplication.getInstance().getResources(), R.drawable.play_page_default_cover);
                bitmap = ImageUtils.resizeImage(bitmap, ContextUtils.getScreenWidth() / 2, ContextUtils.getScreenWidth() / 2);
