...
public class LrcView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.LrcView_textSize, ContextUtils.sp2px(16));
        mDividerHeight = ta.getDimension(R.styleable.LrcView_dividerHeight, ContextUtils.dp2px(24));
