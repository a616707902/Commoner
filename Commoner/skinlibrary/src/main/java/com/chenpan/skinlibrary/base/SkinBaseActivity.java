...
import com.chenpan.skinlibrary.listener.IDynamicNewView;
import com.chenpan.skinlibrary.listener.ISkinUpdate;
import com.chenpan.skinlibrary.load.SkinInflaterFactory;
import com.chenpan.skinlibrary.load.SkinManager;
import com.chenpan.skinlibrary.statusbar.StatusBarBackground;
...
public class SkinBaseActivity extends AppCompatActivity implements ISkinUpdate, IDynamicNewView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getLayoutInflater().setFactory((LayoutInflater.Factory)mSkinInflaterFactory);
