package com.chenpan.commoner.service;
...
import com.chenpan.commoner.receiver.NoisyAudioStreamReceiver;
import com.chenpan.commoner.utils.MusicUtils;
...
//    public AMapLocalWeatherLive mAMapLocalWeatherLive;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (intent.getAction()) {
            case MusicPlayMode.ACTION_MEDIA_PLAY_PAUSE:
                playPause();
                break;
            case MusicPlayMode.ACTION_MEDIA_NEXT:
                next();
                break;
            case MusicPlayMode.ACTION_MEDIA_PREVIOUS:
                prev();
                break;
        }
        return START_NOT_STICKY;
